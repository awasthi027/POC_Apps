Pod::Spec.new do |s|
   ...
   s.subspec "ExtensionSafeAPI" do |extSafeAPI|
      extSafeAPI.dependency "LearningSubspecSDK/Core"
      extSafeAPI.pod_target_xcconfig = { "OTHER_SWIFT_FLAGS" => "$(inherited) -DExtension_Safe_API" }
   end
